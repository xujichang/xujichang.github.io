...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.1bf0956d460b658460b5357e819e25e07b58408dd5d13344f99e5cd0d1beadd2.js',function(){input.required=false;search();});}
